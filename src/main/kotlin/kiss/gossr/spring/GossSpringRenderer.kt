...
open class GossSpringRenderer : GossRenderer() {
    ...
    inline fun <T : CssClass> CENTER(css: KClass<T>, body: () -> Unit = {}) = CENTER(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> SMALL(css: KClass<T>, body: () -> Unit = {}) = SMALL(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> STRIKE(css: KClass<T>, body: () -> Unit = {}) = STRIKE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> STRONG(css: KClass<T>, body: () -> Unit = {}) = STRONG(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> SUB(css: KClass<T>, body: () -> Unit = {}) = SUB(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> SUP(css: KClass<T>, body: () -> Unit = {}) = SUP(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> OL(css: KClass<T>, body: () -> Unit = {}) = OL(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> TBODY(css: KClass<T>, body: () -> Unit = {}) = TBODY(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> THEAD(css: KClass<T>, body: () -> Unit = {}) = THEAD(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> TFOOT(css: KClass<T>, body: () -> Unit = {}) = TFOOT(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> PRE(css: KClass<T>, body: () -> Unit = {}) = PRE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> TT(css: KClass<T>, body: () -> Unit = {}) = TT(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> B(css: KClass<T>, body: () -> Unit = {}) = B(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> P(css: KClass<T>, body: () -> Unit = {}) = P(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> S(css: KClass<T>, body: () -> Unit = {}) = S(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> I(css: KClass<T>, body: () -> Unit = {}) = I(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> U(css: KClass<T>, body: () -> Unit = {}) = U(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> Q(css: KClass<T>, body: () -> Unit = {}) = Q(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> NAV(css: KClass<T>, body: () -> Unit = {}) = NAV(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> H1(css: KClass<T>, body: () -> Unit = {}) = H1(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> H2(css: KClass<T>, body: () -> Unit = {}) = H2(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> H3(css: KClass<T>, body: () -> Unit = {}) = H3(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> H4(css: KClass<T>, body: () -> Unit = {}) = H4(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> H5(css: KClass<T>, body: () -> Unit = {}) = H5(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> H6(css: KClass<T>, body: () -> Unit = {}) = H6(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> NOBR(css: KClass<T>, body: () -> Unit = {}) = NOBR(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> TEXTAREA(css: KClass<T>, body: () -> Unit = {}) = TEXTAREA(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> SECTION(css: KClass<T>, body: () -> Unit = {}) = SECTION(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> ARTICLE(css: KClass<T>, body: () -> Unit = {}) = ARTICLE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> ASIDE(css: KClass<T>, body: () -> Unit = {}) = ASIDE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> HEADER(css: KClass<T>, body: () -> Unit = {}) = HEADER(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> FOOTER(css: KClass<T>, body: () -> Unit = {}) = FOOTER(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> MAIN(css: KClass<T>, body: () -> Unit = {}) = MAIN(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> FIGURE(css: KClass<T>, body: () -> Unit = {}) = FIGURE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> FIGCAPTION(css: KClass<T>, body: () -> Unit = {}) = FIGCAPTION(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> FIELDSET(css: KClass<T>, body: () -> Unit = {}) = FIELDSET(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> LEGEND(css: KClass<T>, body: () -> Unit = {}) = LEGEND(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> EM(css: KClass<T>, body: () -> Unit = {}) = EM(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> BLOCKQUOTE(css: KClass<T>, body: () -> Unit = {}) = BLOCKQUOTE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> CODE(css: KClass<T>, body: () -> Unit = {}) = CODE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> MARK(css: KClass<T>, body: () -> Unit = {}) = MARK(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> CITE(css: KClass<T>, body: () -> Unit = {}) = CITE(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> DL(css: KClass<T>, body: () -> Unit = {}) = DL(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> DT(css: KClass<T>, body: () -> Unit = {}) = DT(CssClass.getCssClassName(css.java), body)
    inline fun <T : CssClass> DD(css: KClass<T>, body: () -> Unit = {}) = DD(CssClass.getCssClassName(css.java), body)
